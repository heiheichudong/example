...
public class RoundImageView extends AppCompatImageView {
    ...
    public RoundImageView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.Round_Image_View, defStyleAttr, 0);

        type = a.getInt(R.styleable.Round_Image_View_type, TYPE_OVAL);
        mBorderColor = a.getColor(R.styleable.Round_Image_View_border_color, Color.WHITE);
        mBorderWidth = a.getDimension(R.styleable.Round_Image_View_border_width, 0);
        mCornerRadius = a.getDimension(R.styleable.Round_Image_View_cornerRadius, dp2px(10));
        mLeftTopCornerRadius = a.getDimension(R.styleable.Round_Image_View_leftTop_corner_radius, 0);
        mLeftBottomCornerRadius = a.getDimension(R.styleable.Round_Image_View_leftBottom_corner_radius,0);
        mRightTopCornerRadius = a.getDimension(R.styleable.Round_Image_View_rightTop_corner_radius,0);
        mRightBottomCornerRadius = a.getDimension(R.styleable.Round_Image_View_rightBottom_corner_radius,0);
