...
public class TextureVideoView extends TextureView
    ...
    public void setMediaPlayer(IjkMediaPlayer IjkMediaPlayer) {
        if (mMediaPlayer == null) {
            ...
            mMediaPlayer.setSurface(getSurface());
            setTextureSize();
        } else if (!mMediaPlayer.equals(IjkMediaPlayer) && mMediaPlayer != null) {
            mMediaPlayer.stop();
    ...
    public void setMediaPlayerOnStart(IjkMediaPlayer IjkMediaPlayer) {
    ...
    private void openVideo() {
        if (mUri == null || mSurface == null || mUri.toString().equals("")) {
        ...
        try {
            ...
            if (mAudioSession != 0) {
                ...
                //setAudioSessionId(mAudioSession);
            } else {
            ...
            new IMediaPlayer.OnErrorListener() {
                ...
                public boolean onError(IMediaPlayer mp, int framework_err, int impl_err) {
                    ...
                    if (getWindowToken() != null) {
                        ...
                        if (framework_err == IjkMediaPlayer.MEDIA_ERROR_NOT_VALID_FOR_PROGRESSIVE_PLAYBACK) {
    ...
    private void updateTextureViewSizeCenter() {
        ...
        Log.e("videovideo", "gw " + getWidth() + "gh " + getHeight() + "vw " + mVideoWidth + "vh " + mVideoHeight);
