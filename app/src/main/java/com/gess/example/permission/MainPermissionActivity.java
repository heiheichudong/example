...
public class MainPermissionActivity extends AppCompatActivity implements EasyPermissions.PermissionCallbacks,
    ...
    public void onPermissionsDenied(int requestCode, @NonNull List<String> perms) {
        ...
        if (EasyPermissions.somePermissionPermanentlyDenied(this, perms)) {
            new AppSettingsDialog.Builder(this).setTitle("提示").setRationale("没有请求的权限，此应用程序可能无法正常工作。\n" +
