...
class CrashHandler private constructor(context: Context) : Thread.UncaughtExceptionHandler {
    ...
    private lateinit var mListener :CrashHandleListener
    ...
    interface CrashHandleListener{
        fun listener(e: Throwable)
    }

    fun setListener(listener:CrashHandleListener){
    ...
    override fun uncaughtException(t: Thread, e: Throwable) {
        ...
        Log.d("CrashHandler",getLogSummary(e))
        exitProcess(0)
    }
